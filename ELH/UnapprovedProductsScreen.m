...
#import "UnapprovedProductsScreen.h"

@interface UnapprovedProductsScreen ()
{
    MBProgressHUD *hud;
...
@implementation UnapprovedProductsScreen
...
-(void)CallWebService {
    ...
    NSString *urlString  =  [NSString stringWithFormat:@"%@%@",BASE_URL,UNAPPROVED_PRODUCT];
